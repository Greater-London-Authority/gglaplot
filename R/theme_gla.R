...
theme_gla <- function(gla_theme = "default",
  ...
  theme_gla <- ggplot2::theme_bw(base_size = base_size) +
    ...
    ggplot2::theme(
      ...
      legend.margin = ggplot2::margin(t = 0, r = 0,
                             l = 0, b = 0, unit = "pt"),

      # facets
      panel.border = ggplot2::element_blank(),
      panel.spacing.y = ggplot2::unit(axis_size + 3 * plot_margin, units = "pt"),
      panel.spacing.x = ggplot2::unit(5 * plot_margin, units = "pt"),
